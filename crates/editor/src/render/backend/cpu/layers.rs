//! CPU base layer preparation, cache management, phase rendering.
//!
//! Renderer가 직접 CPU 구현을 가지는 대신, standalone 함수로 분리.
...
/// 페이지의 base layer(캐시)를 준비한다.
/// background와 content phase를 렌더링하고, dirty rect 기반 캐시 업데이트를 수행.
#[allow(clippy::too_many_arguments)]
pub(in crate::render) fn prepare_base_layer(
    page: &Page,
    page_idx: usize,
    doc: &Doc,
    backend: &mut crate::render::backend::RenderBackend,
    scale_factor: f64,
    theme: &Theme,
    is_focused: bool,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::render) fn render_background_phase(
    buf: &mut PixelBufMut,
    scale_factor: f64,
    theme: &Theme,
    is_focused: bool,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::render) fn render_selection_phase(
    buf: &mut PixelBufMut,
    scale_factor: f64,
    theme: &Theme,
    is_focused: bool,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::render) fn render_content_phase(
    buf: &mut PixelBufMut,
    scale_factor: f64,
    theme: &Theme,
    is_focused: bool,
...
pub(in crate::render) fn ensure_scratch_buf(scratch_buf: &mut PixelBuf, width: u32, height: u32) {
...
pub(in crate::render) fn clear_scratch_region(scratch_buf: &mut PixelBuf, width: u32, height: u32) {
...
pub(in crate::render) fn blit_scratch_region(
    dst: &mut PixelBuf,
    src: &PixelBuf,
    src_width: u32,
    src_height: u32,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::render) fn render_background_phase_clipped(
    ...
    let crate::render::backend::RenderBackend::Cpu { scratch_buf, .. } = backend else {
...
#[allow(clippy::too_many_arguments)]
pub(in crate::render) fn render_selection_phase_clipped(
    buf: &mut PixelBufMut,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::render) fn render_content_phase_clipped_with_scratch(
    buf: &mut PixelBuf,
    backend: &mut crate::render::backend::RenderBackend,
    scale_factor: f64,
    theme: &Theme,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::render) fn render_post_layers(
    buf: &mut PixelBufMut,
    scale_factor: f64,
    theme: &Theme,
    is_focused: bool,
...
pub(in crate::render) fn render_drop_indicator(
    buf: &mut PixelBufMut,
