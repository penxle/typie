...
export type ThemeVariant = "dark-beacon" | "dark-black" | "dark-catppuccin-mocha" | "dark-dracula" | "dark-everforest" | "dark-flexoki" | "dark-github" | "dark-gruvbox-material" | "dark-horizon" | "dark-kanagawa" | "dark-melange" | "dark-modus-vivendi" | "dark-monokai" | "dark-nigecha-dame" | "dark-nightfox" | "dark-nord" | "dark-one" | "dark-rose-pine" | "light-atelier-lakeside" | "light-atelier-seaside" | "light-catppuccin-latte" | "light-cupcake" | "light-everforest" | "light-flexoki" | "light-github" | "light-gruvbox-material" | "light-harbor" | "light-horizon" | "light-kanagawa" | "light-modus-operandi" | "light-monokai" | "light-noctis-lilac" | "light-one" | "light-rose-pine-dawn" | "light-sakura" | "light-silk" | "light-white";
...
export type { Editor, EditorHost, EditorServer, ResourceUpdate };
