...
export const ISpace = createInterfaceRef('ISpace', T.Spaces);
export const IEditorDocument = builder.interfaceRef<{ id: string }>('IEditorDocument');
...
export const Space = createObjectRef('Space', T.Spaces);
export const Publication = createObjectRef('Publication', T.Publications);
export const Collection = createObjectRef('Collection', T.Collections);
...
export const SpaceView = createObjectRef('SpaceView', T.Spaces);
export const PublicationView = createObjectRef('PublicationView', T.Publications);
export const CollectionView = createObjectRef('CollectionView', T.Collections);
