...
export const DocumentCommit = createObjectRef('DocumentCommit', T.DocumentCommits);
export const DocumentConflict = createObjectRef('DocumentConflict', T.DocumentConflicts);
export const DocumentConflictBranch = createObjectRef('DocumentConflictBranch', T.DocumentConflictBranches);
export const DocumentConflictResolution = createObjectRef('DocumentConflictResolution', T.DocumentConflictResolutions);
export const DocumentObject = createObjectRef('DocumentObject', T.DocumentObjects);
