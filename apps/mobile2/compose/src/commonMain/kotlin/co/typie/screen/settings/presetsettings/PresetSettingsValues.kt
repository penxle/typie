...
internal data class PresetOption<T>(val label: String, val value: T)
...
internal val FONT_WEIGHT_OPTIONS =
  listOf(
...
internal val FONT_SIZE_OPTIONS =
  listOf(
...
internal val TEXT_COLOR_OPTIONS =
  listOf(
...
internal val BACKGROUND_COLOR_OPTIONS =
  listOf(
...
internal val LETTER_SPACING_OPTIONS =
  listOf(
...
internal val LINE_HEIGHT_OPTIONS =
  listOf(
...
internal val PARAGRAPH_INDENT_OPTIONS =
  listOf(
...
internal val MAX_WIDTH_OPTIONS =
  listOf(
...
internal val BLOCK_GAP_OPTIONS =
  listOf(
    PresetOption(label = "없음", value = 0),
...
internal val PAGE_LAYOUT_OPTIONS =
  listOf(
...
internal fun getMaxMargin(side: PageMarginSide, layout: PresetLayout.Paginated): Int {
  return when (side) {
    ...
    PageMarginSide.Top ->
      maxOf(0, layout.pageHeight - layout.pageMarginBottom - MIN_CONTENT_SIZE_PX)
    PageMarginSide.Bottom ->
      maxOf(0, layout.pageHeight - layout.pageMarginTop - MIN_CONTENT_SIZE_PX)
  }
}
