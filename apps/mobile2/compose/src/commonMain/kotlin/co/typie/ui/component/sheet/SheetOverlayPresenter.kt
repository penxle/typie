...
internal class SheetOverlayEntry<R> internal constructor(
  ...
  val mode: SheetMode get() = spec.mode
  val isTopOfStack: Boolean get() = controller.isTopOfStack
...
internal class SheetOverlayPresenterState : SheetOverlayPresenter {
  ...
  internal val entries: List<SheetOverlayEntry<*>> get() = _entries
  ...
  override suspend fun <R> present(
    ...
    try {
      return suspendCancellableCoroutine { continuation ->
        ...
        val overlayEntry = SheetOverlayEntry(
          spec = spec,
  ...
  private fun recalculateStackMetadata() {
    ...
    _entries.forEachIndexed { index, entry ->
      entry.controller.updateResolvedDetents(
        detents = entry.controller.resolvedDetents.ifEmpty {
