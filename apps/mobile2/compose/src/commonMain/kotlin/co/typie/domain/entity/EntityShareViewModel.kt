...
import co.typie.graphql.EntityFolderShare_PersistBlobAsImage_Mutation
import co.typie.graphql.EntityFolderShare_UpdateFoldersOption_Mutation
...
internal class EntityShareViewModel(entityIds: List<String>) :
  ...
  override suspend fun updateFoldersVisibility(
    ...
    Apollo.executeMutation(
      EntityFolderShare_UpdateFoldersOption_Mutation(
  ...
  override suspend fun uploadFoldersThumbnail(
    ...
    val image =
      Apollo.executeMutation(
          EntityFolderShare_PersistBlobAsImage_Mutation(
