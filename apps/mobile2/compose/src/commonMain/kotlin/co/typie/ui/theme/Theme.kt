...
val LightColors =
  AppColors(
    ...
    textHint = AppColor.light.gray.s400,
    surfaceCanvas = AppColor.light.gray.s50,
    surfaceDefault = Color(0xFFFFFDF8),
    ...
    textOnDanger = Color(0xFFFFFDF8),
    textOnDangerSubtle = Color(0xFF7A1E35),
    success = Color(0xFF179A69),
    successSubtle = Color(0xFFD8F3E2),
    textOnSuccess = Color(0xFFFFFDF8),
...
val DarkColors =
  AppColors(
    ...
    surfaceInset = AppColor.dark.gray.s700,
    borderEmphasis = AppColor.dark.gray.s500,
    ...
    textOnDanger = AppColor.dark.gray.s950,
    textOnDangerSubtle = Color(0xFFF0C8D0),
    success = Color(0xFF5EB58B),
