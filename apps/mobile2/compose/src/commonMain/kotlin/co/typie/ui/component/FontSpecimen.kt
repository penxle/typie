...
fun FontSpecimen(
  ...
  Box(modifier = modifier.heightIn(min = height), contentAlignment = contentAlignment) {
    Img(url = url, placeholder = fallback, modifier = Modifier.height(height).wrapContentWidth())
  }
}
