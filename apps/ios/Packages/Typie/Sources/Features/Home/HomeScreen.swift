  ...
  public struct HomeScreen<Extra: View>: View {
    ...
    private let model = Container.shared.searchModel()
    ...
    public init(
      search: HomeSearchState, onOpen: @escaping (SearchHit) -> Void,
    ...
    private var placeholder: String {
      HomeSearchState.searchPrompt(siteName: sites.current?.name)
    }
