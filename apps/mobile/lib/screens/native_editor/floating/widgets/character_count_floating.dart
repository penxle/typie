...
import 'package:typie/screens/native_editor/floating/editor_floating_widget.dart';
...
class NativeCharacterCountFloating extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final characterCountState = useValueListenable(scope.controller.characterCounts);
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Text(
                  '${characterCountState.docWithWhitespace.comma}자',
            ...
            if (isExpanded.value) ...[
              ...
              _buildCountRow(label: '공백 미포함', count: characterCountState.docWithoutWhitespace, context: context),
              const SizedBox(height: 4),
              _buildCountRow(
                label: '공백/부호 미포함',
                count: characterCountState.docWithoutWhitespaceAndPunctuation,
                context: context,
              ),
            ],
          ],
