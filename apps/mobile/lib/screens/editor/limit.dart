...
import 'package:typie/screens/editor/__generated__/limit_query.req.gql.dart';
import 'package:typie/screens/editor/__generated__/subscribe_plan_with_trial_mutation.req.gql.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Tappable(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    color: canStartTrial ? context.colors.surfaceMuted : context.colors.surfaceInverse,
                    borderRadius: BorderRadius.circular(8),
                  ),
                  padding: const Pad(vertical: 16),
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.w700,
                      color: canStartTrial ? context.colors.textDefault : context.colors.textInverse,
                    ),
                    textAlign: TextAlign.center,
                  ),
                ),
