      ...
      child: Column(
        ...
        children: [
          if (data.me!.subscription == null) ...[
            ...
            const SettingsSectionLabel(text: '현재 이용 중인 이용권'),
            SettingsSectionCard(
          ...
          const Gap(settingsSectionGap),
          const SettingsSectionLabel(text: 'FULL ACCESS'),
          SettingsSectionCard(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          const Text('타이피 FULL ACCESS', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700)),
                          if (isOnTrial) ...[
                            const Gap(8),
                            Container(
