...
import 'package:typie/modals/__generated__/move_entity_move_entity_mutation.req.gql.dart';
import 'package:typie/modals/__generated__/move_entity_query.data.gql.dart';
import 'package:typie/modals/__generated__/move_entity_query.req.gql.dart';
import 'package:typie/modals/__generated__/move_entity_root_query.data.gql.dart';
import 'package:typie/modals/__generated__/move_entity_root_query.req.gql.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Screen(
      heading: Heading(
        ...
        leading:
            (entities.value?.entity.parent == null && currentParentId.value == null)
                ? const Text('')
                : Tappable(
      ...
      child: Column(
        children: [
          Expanded(
            child:
                (entities.value == null && rootEntities.value == null) || loading.value
                              ...
                              (folderCount == 0)
                                  ...
                                  : ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      final id =
                                          currentParentId.value != null ? children[index].id : rootChildren[index].id;
                                      final typename =
                                          currentParentId.value != null
