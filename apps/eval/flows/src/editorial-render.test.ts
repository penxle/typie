...
import type { EditorialPlan, ResolvedResearch } from './editorial-types.ts';

const RESEARCH: ResolvedResearch = {
  nature: { form: '단편', completeness: '완성고', feedbackFit: '구조 지적 유효' },
...
describe('renderPlanForReview', () => {
  it('계획 JSON·코드 검증·조사 기록을 담는다', () => {
    const plan: EditorialPlan = { intent: 'i', protected: [], axes: [], verifications: [], rejected: [] };
