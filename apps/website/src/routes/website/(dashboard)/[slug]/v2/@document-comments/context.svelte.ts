...
export type { CommentAnchor } from '$lib/editor-ffi/comments';
...
export type CommentController = {
  ...
  captureFocusReturn: (target: EventTarget | null) => void;
  setFocusReturnRegion: (region: HTMLElement | null) => void;
  close: () => void;
