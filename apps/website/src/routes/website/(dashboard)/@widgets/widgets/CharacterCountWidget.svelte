<script lang="ts">
  ...
  let { widgetId, palette = false, editMode = false, editor, data = {} }: Props = $props();
...
<Widget collapsed={isCollapsed} {editMode} icon={TypeIcon} {palette} title="글자 수" {widgetId} widgetType="characterCount">
