      ...
      <div class={flex({ flexDirection: 'column', gap: '24px' })}>
        ...
        >
          ...
          <div class={grid({ gridTemplateColumns: '1fr 1fr', gap: '16px' })}>
            <div>
              <div class={css({ fontSize: '11px', color: 'amber.400', marginBottom: '4px' })}>USER ID</div>
              <div class={css({ fontSize: '12px', color: 'amber.500' })}>
                {$query.adminUser.id}
              </div>
            </div>
            <div>
              <div class={css({ fontSize: '11px', color: 'amber.400', marginBottom: '4px' })}>JOINED</div>
              <div class={css({ fontSize: '12px', color: 'amber.500' })}>
      ...
      <div class={flex({ flexDirection: 'column', gap: '24px' })}>
          ...
          <div class={flex({ flexDirection: 'column', gap: '16px' })}>
            <div class={flex({ alignItems: 'center', justifyContent: 'space-between' })}>
              ...
              <span class={css({ fontSize: '12px', color: $query.adminUser.marketingConsent ? 'green.400' : 'gray.400' })}>
                {$query.adminUser.marketingConsent ? 'ALLOWED' : 'DISABLED'}
              </span>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div class={flex({ flexDirection: 'column', gap: '8px' })}>
            ...
            {#if $query.adminUser.state === 'ACTIVE'}
              <button
                class={css({
                  borderWidth: '1px',
                  borderColor: 'red.500',
