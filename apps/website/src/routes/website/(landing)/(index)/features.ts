    ...
    cards: [
      {
        title: '공개 범위',
        icon: GlobeIcon,
        body: '쓴 글은 내가 열기 전까지 비공개예요. 공개하면 스페이스에 올라가고, 링크 공개로 두면 주소를 아는 사람만 볼 수 있어요.',
      },
      {
        title: '비밀번호와 연령 제한',
        icon: LockIcon,
      ...
      },
      {
        title: '스페이스',
        icon: NewspaperIcon,
        body: '공개한 글은 내 스페이스 주소에 모여요. 주소는 원하는 이름으로 바꿀 수 있어서, 그 자체로 내 글을 모아 보여주는 자리가 돼요.',
      },
    ],
  },
  {
