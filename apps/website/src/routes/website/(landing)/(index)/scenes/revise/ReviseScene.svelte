<script lang="ts">
  ...
  import PrismObject from '$lib/landing/components/PrismObject.svelte';
  ...
  const greetingClass = css({ fontFamily: 'landing', fontSize: { base: '17px', lg: '20px' }, lineHeight: '[1.5]', color: 'text.muted' });
