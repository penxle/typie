<script lang="ts">
  ...
  import AppIcon from '$assets/logos/favicon-light.svg?component';
  ...
  const identityNameClass = css({ fontFamily: 'landing', fontSize: '13px', fontWeight: 'medium', letterSpacing: '[-0.01em]' });
