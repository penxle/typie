<script lang="ts">
  ...
  import type { UsersiteWildcardPublicationPage_CollectionNavigation_publicationView$key } from '$mearie';

  type Props = {
    publicationView$key: UsersiteWildcardPublicationPage_CollectionNavigation_publicationView$key;
  };
  ...
  const publication = createFragment(
    graphql(`
      fragment UsersiteWildcardPublicationPage_CollectionNavigation_publicationView on PublicationView {
        id
