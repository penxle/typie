<script lang="ts">
  ...
  import type { UsersiteWildcardPublicationPage_PublicationEmojiReaction_publicationView$key } from '$mearie';

  type Props = {
    publicationView$key: UsersiteWildcardPublicationPage_PublicationEmojiReaction_publicationView$key;
  };
  ...
  const publication = createFragment(
    graphql(`
      fragment UsersiteWildcardPublicationPage_PublicationEmojiReaction_publicationView on PublicationView {
        id
        documentId
        allowReaction
  ...
  const [createDocumentReaction] = createMutation(
    graphql(`
      mutation UsersiteWildcardPublicationPage_PublicationEmojiReaction_CreateDocumentReaction_Mutation(
        $input: CreateDocumentReactionInput!
      ) {
