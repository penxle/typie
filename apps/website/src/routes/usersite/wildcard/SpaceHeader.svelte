<script lang="ts">
  ...
  import type { UsersiteWildcard_SpaceHeader_spaceView$key } from '$mearie';

  type Props = {
    spaceView$key: UsersiteWildcard_SpaceHeader_spaceView$key;
  ...
  const space = createFragment(
    graphql(`
      fragment UsersiteWildcard_SpaceHeader_spaceView on SpaceView {
        id
        name
        description
        availableActions
