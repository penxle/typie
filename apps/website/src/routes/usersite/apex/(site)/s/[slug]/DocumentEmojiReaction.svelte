<script lang="ts">
  ...
  import type { UsersiteApexSlugPage_DocumentEmojiReaction_documentView$key } from '$mearie';

  type Props = {
    documentView$key: UsersiteApexSlugPage_DocumentEmojiReaction_documentView$key;
  };
  ...
  const documentView = createFragment(
    graphql(`
      fragment UsersiteApexSlugPage_DocumentEmojiReaction_documentView on DocumentView {
        id
        allowReaction
  ...
  const [createDocumentReaction] = createMutation(
    graphql(`
      mutation UsersiteApexSlugPage_DocumentEmojiReaction_CreateDocumentReaction_Mutation($input: CreateDocumentReactionInput!) {
