<script lang="ts">
      ...
      fragment UsersiteApexSlugPage_DocumentViewV2_entityView on EntityView {
        ...
        node {
          ...
          ... on DocumentView {
            ...
            ...Editor_document
            ...UsersiteApexSlugPage_DocumentEmojiReaction_documentView
          }
        }

        ...UsersiteApexSlugPage_DocumentActionMenu_entityView
        ...UsersiteApexSlugPage_ContentNavigation_entityView
      }
    `),
    () => entityView$key,
  );
  ...
  const [verifyPersonalIdentity] = createMutation(
    graphql(`
      mutation UsersiteApexSlugPage_DocumentViewV2_VerifyPersonalIdentity_Mutation($input: VerifyPersonalIdentityInput!) {
