<script lang="ts">
  ...
  import type { UsersiteSpace_SpaceSettingsCollectionsTab_space$key } from '$mearie';

  type Props = {
    space$key: UsersiteSpace_SpaceSettingsCollectionsTab_space$key;
  };
  ...
  const space = createFragment(
    graphql(`
      fragment UsersiteSpace_SpaceSettingsCollectionsTab_space on Space {
        id
  ...
  const [createCollection] = createMutation(
    graphql(`
      mutation UsersiteSpace_SpaceSettingsCollectionsTab_CreateCollection_Mutation($input: CreateCollectionInput!) {
  ...
  const [updateCollection] = createMutation(
    graphql(`
      mutation UsersiteSpace_SpaceSettingsCollectionsTab_UpdateCollection_Mutation($input: UpdateCollectionInput!) {
  ...
  const [deleteCollection] = createMutation(
    graphql(`
      mutation UsersiteSpace_SpaceSettingsCollectionsTab_DeleteCollection_Mutation($input: DeleteCollectionInput!) {
