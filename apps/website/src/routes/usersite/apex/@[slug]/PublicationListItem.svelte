<script lang="ts">
  ...
  type Props = {
    publicationView$key: UsersiteSpace_PublicationListItem_publicationView$key;
  ...
  const publication = createFragment(
    graphql(`
      fragment UsersiteSpace_PublicationListItem_publicationView on PublicationView {
        id
        title
        subtitle
        excerpt
