...
<Helmet
  description="창작자가 기다려온 글쓰기 앱 글리터를 만나보세요. 기본적인 텍스트 편집은 물론, 다양한 꾸밈 요소와 글쓰기 편의 기능으로 작품의 완성도를 높이고 나만의 개성을 더할 수 있어요. 링크를 생성하거나 비밀번호를 설정해서 원하는 독자에게만 창작물을 공유할 수도 있어요. 전하고 싶은 만큼, 원하는 사람에게만 안전하게 공유하세요."
  image={{ src: 'https://cdn.glttr.io/opengraph/default.png', size: 'large' }}
  title="글리터 — 몰입해서 쓰고, 유연하게 공유하고, 깔끔하게 정리하는 스마트한 에디터"
  trailing={null}
/>
