use super::{
    PixelBuf, PixelBufMut, blend_row_const_src_over_lut, blend_row_const_src_over_opaque,
    blend_row_src_over, build_const_src_over_lut, render_selection_phase,
};
...
pub fn composite_cached_content_layer_clipped(
    buf: &mut PixelBufMut,
...
pub fn fill_layout_rects_src_over(
    buf: &mut PixelBufMut,
    rects: &[LayoutRect],
    scale_factor: f64,
    color: Color,
...
pub fn composite_scratch_region_src_over(
    dst: &mut PixelBufMut,
    src: &PixelBuf,
    src_width: u32,
    src_height: u32,
...
pub fn composite_src_over(dst: &mut PixelBufMut, src: &PixelBuf, dst_x: i32, dst_y: i32) {
...
pub fn fill_pixel_rect_src_over(
    buf: &mut PixelBufMut,
    x: i32,
    y: i32,
    w: u32,
