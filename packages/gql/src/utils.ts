...
export const removeDirective = (node: graphql.OperationDefinitionNode | graphql.FragmentDefinitionNode, names: string[]) => {
...
export const addIdAndTypenameField = (
  ...
  if (
    ...
    (newNode.kind === 'FragmentDefinition' && ['Query', 'Mutation', 'Subscription'].includes(newNode.typeCondition.name.value))
  ) {
