      ...
      if (graphql.isScalarType(fieldType)) {
        selections.push({
          ...
          type: {
            ...
            isNonNull: hasDirective(selection.directives, 'required') || graphql.isNonNullType(field.type),
          },
        });
...
export const getReferencedFragments = (selections: Selection[], fragmentMap: Map<string, FragmentArtifact>): FragmentArtifact[] => {
