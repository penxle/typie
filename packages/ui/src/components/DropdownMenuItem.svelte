    ...
    css(
      {
        ...
        _hover: focusManaged ? undefined : { color: active ? 'accent.default' : 'text.default', backgroundColor: 'surface.hover' },
        _focus: { color: active ? 'accent.default' : 'text.default', backgroundColor: 'surface.hover' },
      },
      style,
    ),
  )}
