...
export const TOOL_META: Record<string, ToolMeta> = {
  ...
  'create-folder': { resolver: 'server', tier: 'safe' },
  'create-document': { resolver: 'server', tier: 'safe' },
  'rename-folder': { resolver: 'server', tier: 'safe' },
  'move-entities': { resolver: 'server', tier: 'safe' },
  'duplicate-document': { resolver: 'server', tier: 'safe' },
  'create-note': { resolver: 'server', tier: 'safe' },
  'update-note': { resolver: 'server', tier: 'safe' },
  'attach-note': { resolver: 'server', tier: 'safe' },
  'detach-note': { resolver: 'server', tier: 'safe' },
  'set-goal': { resolver: 'server', tier: 'safe' },
  'update-icon': { resolver: 'server', tier: 'safe' },
  'recover-entity': { resolver: 'server', tier: 'safe' },
  'delete-entities': { resolver: 'user', tier: 'destructive' },
  'delete-note': { resolver: 'user', tier: 'destructive' },
  'delete-goal': { resolver: 'user', tier: 'destructive' },
